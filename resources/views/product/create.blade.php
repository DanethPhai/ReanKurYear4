    ...
    <div class="mx-auto w-1/3 bg-white rounded-lg" >
        <div class="p-4">
            ...
            >
                ...
                <h3 class=" font-medium pb-3 text-center">Create Post</h3>
                ...
                <div class="mb-3">
                    ...
                    <select id='level_id' name='level_id' class="form-control" aria-placeholder="Choose" required>
                ...
                <div class=" grid grid-cols-5 gap-3 ">
                    <div class="mb-3 col-span-3">
                        <label for="price" class="form-label">តម្លៃ(៛)<span class="text-danger">*</span></label>
                        <input id="price" name="price" type="text" class="form-control" required>
                    </div>
                    <div class="mb-3 col-span-2">
                        <label for="term" class="form-label">រយះពេល<span class="text-danger">*</span></label>
                        <input id="term" name="term" type="text" class="form-control" required>
                    </div>
                </div>
